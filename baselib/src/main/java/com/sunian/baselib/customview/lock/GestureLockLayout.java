package com.sunian.baselib.customview.lock;
...
import com.sunian.baselib.util.DipAndPX;
...
public class GestureLockLayout extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mPaint.setStrokeWidth(DipAndPX.dp2px(context, mStrokeWidth));
    ...
    public void setPathWidth(float dp) {
        mPaint.setStrokeWidth(DipAndPX.dp2px(getContext(), dp));
    }
